...
namespace OnlineCinemaApp.Services.Implementation
{
    public class ShoppingCartService : IShoppingCartService
    {
        ...
        public ShoppingCartService( IRepository<ShoppingCart> shoppingCartRepository, IRepository<EmailMessage> mailRepository, IUserRepository userRepository, IRepository<Order> orderRepositorty, IRepository<ProductInOrder> productInOrderRepositorty)
        {
        ...
        public bool deleteProductFromShoppingCart(string userId, Guid id)
        {
            if (!string.IsNullOrEmpty(userId) && id != null)
            {
                ...
                var itemToDelete = userShoppingCart.Products.Where(z => z.ShoppingCartId.Equals(id)).FirstOrDefault();
